/*
 * Megan7.java Copyright (C) 2024 Daniel H. Huson
 *
...
public class Megan7 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //run application
            (new Megan7()).parseArguments(args);
    ...
    private void parseArguments(String[] args) throws Exception {
        ...
        ProgramProperties.setProgramLicence("""
				Copyright (C) 2025 Daniel H. Huson. This program comes with ABSOLUTELY NO WARRANTY.
        ...
        final var options = new ArgsOptions(args, this, "MEGAN 7 MetaGenome Analyzer Community Edition");
        if (options.isDoHelp()) {
